...
The `pull` command fetches the alpine **image** from the **Docker registry** and saves it in our system. In this case the registry is **[Docker Cloud](https://cloud.docker.com)**. You can change the registry, but that's a different lab.
